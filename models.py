...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if not self.hazardous:
            hazardcheck = 'not'
        return f"Neo {self.fullname} has a diameter of {self.diameter:.3f} Km and is {hazardcheck} potentially hazardous."
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        # TODO: Use self.designation and self.name to build a fullname for this object.
        dt = cd_to_datetime(self.time_st)
        self.time = datetime_to_str(dt)
        return self.time
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"On  {self.time_str}, a '{self.designation} {self.neo.name}' approaches Earth at a distance of {self.distance:.2f} au and a velocity of {self.velocity:.2f} km/s."

    def __repr__(self):
        """Return `repr(self)`, a computer-readable string representation of this object."""
        return (f"CloseApproach(time={self.time!r},designation={self.designation!r}, distance={self.distance:.2f}, "
